...
[![Build Status](https://travis-ci.org/hrbrmstr/crafter.svg)](https://travis-ci.org/hrbrmstr/crafter) 
![Project Status: Concept - Minimal or no implementation has been done yet.](http://www.repostatus.org/badges/0.1.0/concept.svg)](http://www.repostatus.org/#concept)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/crafter)](http://cran.r-project.org/web/packages/crafter) 
![downloads](http://cranlogs.r-pkg.org/badges/grand-total/crafter)
